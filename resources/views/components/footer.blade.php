<!-- Footer -->
<footer class="text-center text-lg-start yellowZooBg text-muted">
    <!-- Section: Social media -->
    <section class="d-flex justify-content-center p-4 border-bottom">
      <!-- Left -->
      <div class="me-5 d-none d-lg-block">
        <span>Raggiungici sui social:</span>
      </div>
      <!-- Left -->
  
      <!-- Right -->
      <div>
        <a href="" class="mx-2 link-secondary">
      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
            ...
            <a href="tel:045.6402881"><i class="fas fa-phone me-3"></i> +39 045.6402881</a><br>
            <a href="fax:045.6402872"><i class="fas fa-print me-3"></i> +39 045.6402872</a>
          </div>
          <!-- Grid column -->
        </div>
        <!-- Grid row -->
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
      © 2022 Copyright:
      <a class="text-reset fw-bold" href="https://ristocloudgroup.com/">Ristocloudgroup.com</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->